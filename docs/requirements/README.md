...
- [服务端生成任务接管与独立任务服务需求文档](./SERVER_GENERATION_TASK_ORCHESTRATION_REQUIREMENTS.md)
- [服务端生成任务接管 Phase 0 ADR](./SERVER_GENERATION_TASK_SERVICE_PHASE0_ADR.md)
- [服务端生成任务服务 API Contract](./SERVER_GENERATION_TASK_SERVICE_API_CONTRACT.md)
...
- [专题案例与引导式创作能力需求文档](./SHOWCASE_TOPICS_AND_GUIDED_CREATION_REQUIREMENTS.md)

...
} from '@/features/workbench/workspace/workspace-history-stats';
...
export default function HomePage() {
    ...
    const workspaceHistoryStats = React.useMemo(
        () => buildWorkspaceHistoryStats({ imageHistory: history, visionTextHistory, videoHistory }),
        [history, videoHistory, visionTextHistory]
    );

    const runningWorkspaceIds = React.useMemo(() => {
        return collectRunningWorkspaceIds({ imageTasks: tasks, videoTasks: videoManager.tasks });
    ...
    return (
        <WorkbenchShell
            t={t}
            isGlobalDragOver={isGlobalDragOver}
            workspace={{
                left: {
                    tab: leftWorkspacePanelTab,
                ...
                featureMenuRightBoundary: workspaceFeatureMenuRightBoundary,
                onPanelTabChange: handleWorkspacePanelTabChange,
                onPanelClose: handleWorkspacePanelClose,
                onPanelCollapseChange: handleWorkspacePanelCollapseChange,
                onPanelWidthChange: handleWorkspacePanelWidthChange,
                onPanelResizeEnd: handleWorkspacePanelResizeEnd,
                onPanelReset: handleWorkspacePanelReset,
                onUseAssetLibraryFiles: handleUseAssetLibraryFiles,
                onOpenAssetLibrarySurface: handleOpenAssetLibrarySurface
            }}
            header={{
            ...
            errorState={{
                error,
                displayedMessage: displayedErrorMessage,
                guidanceTarget: errorGuidanceTarget,
                onConfigureGuidance: openConfigurationGuidanceTarget,

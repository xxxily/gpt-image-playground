                            ...
                            <div id='advanced-image-options' className='space-y-5 border-t border-white/[0.06] p-3'>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <div className='flex items-center gap-2'>
                                                    ...
                                                    />
                                                    <Label htmlFor='edit-enable-streaming' className={`text-sm ${streamLabel}`}>启用流式预览</Label>
                                                </div>
                                            </TooltipTrigger>
                                ...
                                {enableStreaming && (
                                    <div className='space-y-3'>
                                        ...
                                        <RadioGroup value={String(partialImages)} onValueChange={handleSetPartialImages} className='flex gap-x-5'>
                                            {[1, 2, 3].map((value) => (
                                                <div key={value} className='flex items-center space-x-2'>
                                                    <RadioGroupItem
                                                        ...
                                                        className='border-white/40 text-white data-[state=checked]:border-white data-[state=checked]:text-white'
                                                    />
                                                    <Label htmlFor={`edit-partial-${value}`} className='cursor-pointer text-white/80'>{value}</Label>
                                                </div>
                                            ))}
                                        </RadioGroup>
                                    </div>
                                ...
                                {hasSourceImages && <div className='space-y-3'>
                                    ...
                                    <Button
                                        ...
                                        {editShowMaskEditor ? '关闭蒙版编辑器' : editGeneratedMaskFile ? '编辑已保存蒙版' : '创建蒙版'}
                                        {editIsMaskSaved && !editShowMaskEditor && <span className='ml-auto text-xs text-green-400'>(已保存)</span>}
                                    ...
                                    {editShowMaskEditor && firstImagePreviewUrl && editOriginalImageSize && (
                                        <div className='space-y-3 rounded-xl border border-white/[0.06] bg-white/[0.02] p-3'>
                                            <p className='text-xs text-white/60'>在下方图片上绘制，标记需要编辑的区域 (绘制区域在蒙版中变为透明)。</p>
                                            <div
                                            ...
                                            <div className='space-y-2 pt-2'>
                                                <Label htmlFor='brush-size-slider' className='text-sm text-white'>笔刷大小: {editBrushSize[0]}px</Label>
                                                <Slider
                                            ...
                                            {editMaskPreviewUrl && (
                                                <div className='mt-3 border-t border-white/10 pt-3 text-center'>
                                                    <Label className='mb-1.5 block text-sm text-white'>蒙版预览:</Label>
                                            ...
                                            {editIsMaskSaved && !editMaskPreviewUrl && <p className='pt-1 text-center text-xs text-yellow-400'>蒙版生成中...</p>}
                                            {editIsMaskSaved && editMaskPreviewUrl && <p className='pt-1 text-center text-xs text-green-400'>蒙版保存成功！</p>}
                                        </div>
                                    )}
                                    {!editShowMaskEditor && editGeneratedMaskFile && <p className='pt-1 text-xs text-green-400'>已应用蒙版: {editGeneratedMaskFile.name}</p>}
                                </div>}

                                <div className='space-y-3'>
                                    <Label className='block text-white'>尺寸</Label>
                                    <RadioGroup value={editSize} onValueChange={handleSetEditSize} className='flex flex-wrap gap-3'>
                                        ...
                                        {isGptImage2 && (
                                            <div className='rounded-xl border border-white/[0.06] bg-white/[0.02] px-3 py-2 transition-all hover:bg-white/[0.06]'>
                                                <RadioItemWithIcon value='custom' id='edit-size-custom' label='自定义' Icon={SquareDashed} />
                                            </div>
                                        )}
                                    </RadioGroup>
                                        ...
                                        <div className='space-y-2 rounded-xl border border-white/[0.06] bg-white/[0.02] p-3'>
                                            <div className='flex items-center gap-3'>
                                                <div className='flex-1 space-y-1'>
                                                    <Label htmlFor='edit-custom-width' className='text-xs text-white/70'>宽度 (px)</Label>
                                                    <Input
                                                ...
                                                <div className='flex-1 space-y-1'>
                                                    <Label htmlFor='edit-custom-height' className='text-xs text-white/70'>高度 (px)</Label>
                                                    <Input
                                            ...
                                            <p className='text-xs text-white/50'>
                                                {(editCustomWidth * editCustomHeight).toLocaleString()} 像素 ({((editCustomWidth * editCustomHeight) / 8_294_400 * 100).toFixed(1)}% 最大值) ·{' '}
                                            ...
                                            {!customSizeValidation.valid && <p className='text-xs text-red-400'>{customSizeValidation.reason}</p>}
                                            <p className='text-xs text-white/40'>限制: 16 的倍数，边长最大 3840px，宽高比 ≤ 3:1，总像素 655,360 至 8,294,400。</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className='space-y-3'>
                                    ...
                                    <RadioGroup value={editQuality} onValueChange={handleSetEditQuality} className='flex flex-wrap gap-3'>
                                        <div className='rounded-xl border border-white/[0.06] bg-white/[0.02] px-3 py-2 transition-all hover:bg-white/[0.06]'>
                                ...
                                {showGenerationOptions && !isGptImage2 && (
                                    <div className='space-y-3'>
                                        ...
                                        <RadioGroup value={background} onValueChange={handleSetBackground} className='flex flex-wrap gap-x-5 gap-y-3'>
                                ...
                                {showGenerationOptions && (
                                    <div className='space-y-3'>
                                        ...
                                        <RadioGroup value={outputFormat} onValueChange={handleSetOutputFormat} className='flex flex-wrap gap-x-5 gap-y-3'>
                                ...
                                {showCompression && (
                                    <div className='space-y-2 pt-2 transition-opacity duration-300'>
                                        <Label htmlFor='unified-compression-slider' className='text-white'>压缩率: {compression[0]}%</Label>
                                        <Slider
                                ...
                                {showGenerationOptions && (
                                    <div className='space-y-3'>
                                        ...
                                        <RadioGroup value={moderation} onValueChange={handleSetModeration} className='flex flex-wrap gap-x-5 gap-y-3'>

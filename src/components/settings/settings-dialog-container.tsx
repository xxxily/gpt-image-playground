...
export function SettingsDialog({ onConfigChange, openTarget }: SettingsDialogProps) {
    ...
    const modelCatalogFilters = React.useMemo(
        () => ({
    ...
    const filteredModelCatalogEntries = React.useMemo(
        () =>
            filterModelCatalogEntries({
                ...
                endpointsById: modelCatalogEndpointById,
                filters: modelCatalogFilters
            }),
        [modelCatalog, modelCatalogEndpointById, modelCatalogFilters]
    );
    const groupedModelCatalogEntries = React.useMemo(
        () => groupModelCatalogEntriesByProvider(filteredModelCatalogEntries),
        [filteredModelCatalogEntries]
    );
    const modelCatalogActiveFilterCount = countActiveModelCatalogFilters(modelCatalogFilters);

    ...
    const persistDraft = React.useCallback(
        (patch?: Partial<BatchPlanDraft>) => {
            ...
            if (nextTargetCount !== undefined) {
                nextDraft.targetCount = nextTargetCount;
            } else {
                delete (nextDraft as Partial<BatchPlanDraft>).targetCount;
            }
                                        ...
                                        <RadioGroup
                                            ...
                                            <label
                                                className={cn(
                                                    ...
                                                    countMode === 'auto' && 'border-violet-500/50 bg-violet-500/10'
                                                )}>
                                            ...
                                            <label
                                                className={cn(
                                                    'border-border flex items-center gap-2 rounded-xl border px-3 py-2',
                                                    countMode === 'fixed' && 'border-violet-500/50 bg-violet-500/10'
                                                )}>

...
const EXTENDED_EXACT_ZH_TO_EN: Record<string, string> = {
    ...
    '请输入有效的宽度和高度。': 'Enter a valid width and height.',
    '宽度和高度必须是整数。': 'Width and height must be whole numbers.',
    '宽度和高度都需要是 16 的倍数。': 'Width and height must both be multiples of 16.',
    '最长边不能超过 3840px。': 'The longest edge cannot exceed 3840px.',
    '长短边比例不能超过 3:1。': 'The long-to-short edge ratio cannot exceed 3:1.',
    '总像素不能低于 655,360。': 'Total pixels cannot be below 655,360.',
    '总像素不能超过 8,294,400。': 'Total pixels cannot exceed 8,294,400.',
    '填写宽度和高度后显示像素与比例。': 'Enter width and height to show pixels and ratio.',
    ...
    排队中: 'Queued',
    重试: 'Retry',
    '任务参数已释放，请重新提交。': 'Task parameters have been released. Submit the task again.',

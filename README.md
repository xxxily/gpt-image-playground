...
- **文生视频 / 图生视频**：通过提示词工具栏切换到视频模式，使用 OpenAI Sora、Google Veo、Runway、Luma、Wan 等供应商生成视频；首版完整覆盖 12 个协议端点（其中 Sora 与 Wan 已端到端就绪，详见 `docs/requirements/VIDEO_GENERATION_REQUIREMENTS.md`）。
